...
class RNCNaverMapPathManager : RNCNaverMapPathManagerSpec<RNCNaverMapPath>() {
    ...
    override fun setZIndexValue(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.zIndex = value
    }

    @ReactProp(name = "isHidden")
    override fun setIsHidden(view: RNCNaverMapPath?, value: Boolean) = view.withOverlay {
        it.isVisible = !value
    }

    @ReactProp(name = "minZoom")
    override fun setMinZoom(view: RNCNaverMapPath?, value: Double) = view.withOverlay {
        it.minZoom = value
    }

    @ReactProp(name = "maxZoom")
    override fun setMaxZoom(view: RNCNaverMapPath?, value: Double) = view.withOverlay {
        it.maxZoom = value
    }

    @ReactProp(name = "isMinZoomInclusive")
    override fun setIsMinZoomInclusive(view: RNCNaverMapPath?, value: Boolean) =
        view.withOverlay {
            it.isMinZoomInclusive = value
        }

    @ReactProp(name = "isMaxZoomInclusive")
    override fun setIsMaxZoomInclusive(view: RNCNaverMapPath?, value: Boolean) =
        view.withOverlay {
    ...
    override fun setCoords(view: RNCNaverMapPath?, value: ReadableArray?) = view.withOverlay {
    ...
    override fun setPassedOutlineColor(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.passedOutlineColor = value
    }


    @ReactProp(name = "color")
    override fun setColor(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.color = value
    }

    @ReactProp(name = "passedColor")
    override fun setPassedColor(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.passedColor = value
    }


    @ReactProp(name = "pattern")
    override fun setPatternInterval(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.patternInterval = value
    }

    @ReactProp(name = "progress")
    override fun setProgress(view: RNCNaverMapPath?, value: Double) = view.withOverlay {
        it.progress = value
    }

    @ReactProp(name = "outlineColor")
    override fun setOutlineColor(view: RNCNaverMapPath?, value: Int) = view.withOverlay {
        it.outlineColor = value
    }

    @ReactProp(name = "isHideCollidedSymbols")
    override fun setIsHideCollidedSymbols(view: RNCNaverMapPath?, value: Boolean) =
        view.withOverlay {
            it.isHideCollidedSymbols = value
        }

    @ReactProp(name = "isHideCollidedMarkers")
    override fun setIsHideCollidedMarkers(view: RNCNaverMapPath?, value: Boolean) =
        view.withOverlay {
            it.isHideCollidedMarkers = value
        }

    @ReactProp(name = "isHideCollidedCaptions")
    override fun setIsHideCollidedCaptions(view: RNCNaverMapPath?, value: Boolean) =
        view.withOverlay {
