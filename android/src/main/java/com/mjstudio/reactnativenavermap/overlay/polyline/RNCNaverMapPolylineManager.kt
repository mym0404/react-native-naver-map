...
class RNCNaverMapPolylineManager : RNCNaverMapPolylineManagerSpec<RNCNaverMapPolyline>() {
    ...
    override fun setZIndexValue(view: RNCNaverMapPolyline?, value: Int) = view.withOverlay {
        it.zIndex = value
    }

    @ReactProp(name = "isHidden")
    override fun setIsHidden(view: RNCNaverMapPolyline?, value: Boolean) = view.withOverlay {
        it.isVisible = !value
    }

    @ReactProp(name = "minZoom")
    override fun setMinZoom(view: RNCNaverMapPolyline?, value: Double) = view.withOverlay {
        it.minZoom = value
    }

    @ReactProp(name = "maxZoom")
    override fun setMaxZoom(view: RNCNaverMapPolyline?, value: Double) = view.withOverlay {
        it.maxZoom = value
    }

    @ReactProp(name = "isMinZoomInclusive")
    override fun setIsMinZoomInclusive(view: RNCNaverMapPolyline?, value: Boolean) =
        view.withOverlay {
            it.isMinZoomInclusive = value
        }

    @ReactProp(name = "isMaxZoomInclusive")
    override fun setIsMaxZoomInclusive(view: RNCNaverMapPolyline?, value: Boolean) =
        view.withOverlay {
    ...
    override fun setCoords(view: RNCNaverMapPolyline?, value: ReadableArray?) = view.withOverlay {
    ...
    override fun setColor(view: RNCNaverMapPolyline?, value: Int) = view.withOverlay {
        it.color = value
    }

    @ReactProp(name = "pattern")
    override fun setPattern(view: RNCNaverMapPolyline?, value: ReadableArray?) = view.withOverlay {
    ...
    override fun setCapType(view: RNCNaverMapPolyline?, value: String?) = view.withOverlay {
        it.capType = when (value) {
    ...
    override fun setJoinType(view: RNCNaverMapPolyline?, value: String?) = view.withOverlay {
        it.joinType = when (value) {
