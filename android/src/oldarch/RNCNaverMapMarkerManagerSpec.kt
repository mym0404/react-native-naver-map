...
internal interface RNCNaverMapMarkerManagerInterface<T : ViewGroup?> {
    fun setCoord(view: T, value: ReadableMap?)
    ...
    fun setHeight(view: T, value: Double)
    fun setAnchor(view: T, value: ReadableMap?)
    fun setAngle(view: T, value: Double)
    fun setIsFlatEnabled(view: T, value: Boolean)
    fun setIsIconPerspectiveEnabled(view: T, value: Boolean)
    fun setAlpha(view: T, value: Double)
