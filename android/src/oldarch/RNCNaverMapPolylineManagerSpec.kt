...
internal interface RNCNaverMapPolylineManagerInterface<T : View?> {
    ...
    fun setPattern(view: T, value: ReadableArray?)
    fun setCapType(view: T, value: String?)
    fun setJoinType(view: T, value: String?)
}


abstract class RNCNaverMapPolylineManagerSpec<T : View> : SimpleViewManager<T>(),
