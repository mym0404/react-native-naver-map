...
```tsx filename="LocalImageMarker.tsx"
<NaverMapMarkerOverlay
  latitude={37.5665}
  longitude={126.9780}
...
<Tabs items={['Android', 'iOS']}>
  <Tabs.Tab>
    ...
    ```tsx filename="AndroidAssetMarker.tsx"
    <NaverMapMarkerOverlay
      latitude={37.5665}
      longitude={126.9780}
  ...
  <Tabs.Tab>
    ...
    ```tsx filename="iOSAssetMarker.tsx"
    <NaverMapMarkerOverlay
      latitude={37.5665}
      longitude={126.9780}
...
```tsx filename="NetworkImageMarker.tsx"
<NaverMapMarkerOverlay
  latitude={37.5665}
  longitude={126.9780}
...
```tsx filename="CustomViewMarker.tsx"
...
```tsx filename="DynamicCustomMarker.tsx"
...
```tsx filename="AnimatedMarker.tsx"
...
```tsx filename="MarkerStateManagement.tsx"
...
```tsx filename="OptimizedCustomMarker.tsx"
// ❌ 잘못된 예시
...
```tsx filename="LargeMarkerSet.tsx"
...
```tsx filename="AnimatedMarkerPosition.tsx"
import { useEffect, useRef } from 'react';
