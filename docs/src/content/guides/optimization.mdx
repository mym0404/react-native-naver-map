...
```tsx filename="ZoomBasedFiltering.tsx"
...
```tsx filename="BuiltinClustering.tsx"
...
```tsx filename="DebouncedCameraEvents.tsx"
...
```tsx filename="ConditionalRendering.tsx"
