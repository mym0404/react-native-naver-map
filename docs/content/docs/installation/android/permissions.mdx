...
<Callout type="info">
네이버 맵 SDK에서 내부적으로 사용하는 `FusedLocationSource`는 사용자가 [isShowLocationButton prop](https://mym0404.github.io/react-native-naver-map/interfaces/NaverMapViewProps.html#isShowLocationButton)을 `true`로 설정하는 순간 자동으로 권한을 요청합니다.
</Callout>
