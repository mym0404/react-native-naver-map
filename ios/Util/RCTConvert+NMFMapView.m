...
+ (RNCNaverMapRegion*)RNCNaverMapRegion:(id)json {
  json = [self NSDictionary:json];
  return RNCNaverMapRegionMake([self double:json[@"latitude"]], [self double:json[@"longitude"]],
...
+ (RNCNaverMapRect*)RNCNaverMapRect:(id)json {
  json = [self NSDictionary:json];
  return RNCNaverMapRectMake([self double:json[@"top"]], [self double:json[@"right"]],
                             [self double:json[@"bottom"]], [self double:json[@"left"]]);
}
